...
//Define o componente de classe MyClassComponent que herda funcionalidades do React.
class MyClassComponent extends Component {
    //Constructor inicializa o estado do componente e recebe as props passadas pelo componente pai.
    constructor(props) {
        super(props); //Chama o construtor da classe Component, passando as props para que o React configure-as internamente
        //O super(props) passa as props que o componente filho (MyClassComponent) recebeu para o construtor da classe Component( React).
        //O React então  trata de distribuir essas props internamente, permitindo que o componente acesse elas via this.props.
    ...
    //Método incrementCount: Será chamado ao clicar no botão
    incrementCount = () => {
...
//O super(props) está passando as props que o MyClassComponent recebel para o Component, para que ele trate e distribu a entre os atributos e métodos internos da classe Component e possa inicializar na MyClassComponent.